...
class BoostyBridge extends BridgeAbstract
{
    ...
    const DESCRIPTION = 'Parser for Boosty (free posts and paid announcements) into RSS feed';
    const MAINTAINER = 'LordArrin';
    const CACHE_TIMEOUT = 3600;

    const PARAMETERS = [[
        'blog'     => ['name' => 'Blog slug', 'type' => 'text', 'required' => true, 'title' => 'Channel name, for example, rebel_jack from https://boosty.to/rebel_jack'],
