...
class StavebninyDEKBridge extends BridgeAbstract
{
    const NAME = 'Stavebniny DEK Bridge';
    const URI = 'https://www.dek.cz/';
    const DESCRIPTION = 'News, events and promotions on DEK building materials - www.dek.cz - Czech Republic';
