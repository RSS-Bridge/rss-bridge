...
class LaMontagneBridge extends BridgeAbstract
{
    const NAME = 'La Montagne';
    const URI = 'https://www.lamontagne.fr/';
    const DESCRIPTION = 'Return latest headlines or local news for La Montagne website (lamontagne.fr).';
    ...
    const PARAMETERS = [
        ...
        'Local news' => [
            'locality-slug' => [
                ...
                'exampleValue' => 'clermont-ferrand-63000'
            ],
        ]
    ];
