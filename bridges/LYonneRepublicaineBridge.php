...
class LYonneRepublicaineBridge extends BridgeAbstract
{
    const NAME = 'L\'Yonne Républicaine';
    const URI = 'https://www.lyonne.fr/';
    const DESCRIPTION = 'Return latest headlines or local news for L\'Yonne Républicaine website (lyonne.fr).';
