...
class WallpaperflareBridge extends XPathAbstract {
	...
	const USER_EXPRESSION_ITEM = './/figure';
	const USER_EXPRESSION_ITEM_TITLE = './/img/@title';
	const USER_EXPRESSION_ITEM_CONTENT = '';
	const USER_EXPRESSION_ITEM_URI = './/a[@itemprop="url"]/@href';
	const USER_EXPRESSION_ITEM_AUTHOR = '/html[1]/body[1]/main[1]/section[1]/h1[1]';
	const USER_EXPRESSION_ITEM_TIMESTAMP = '';
	const USER_EXPRESSION_ITEM_ENCLOSURES = './/img/@data-src';
	const USER_EXPRESSION_ITEM_CATEGORIES = './/figcaption[@itemprop="caption description"]';
