...
class LeBerryRepublicainBridge extends BridgeAbstract
{
    const NAME = 'Le Berry Républicain';
    const URI = 'https://www.leberry.fr/';
    const DESCRIPTION = 'Return latest headlines or local news for Le Berry Républicain website (leberry.fr).';
