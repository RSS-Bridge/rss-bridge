...
class GQMagazineBridge extends BridgeAbstract
{
    ...
    const DESCRIPTION = 'GQMagazine section extractor bridge. This bridge allows you get only a specific section.<br/>' 
        . 'I typically use it to get articles published by Maia Mazaurette by configuring it to use gqmagazine.fr as domain and journaliste/maia-mazaurette as page.';
