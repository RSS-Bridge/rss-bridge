...
class LaRepubliqueDuCentreBridge extends BridgeAbstract
{
    const NAME = 'La République Du Centre';
    const URI = 'https://www.larep.fr/';
    const DESCRIPTION = 'Return latest headlines or local news for La République Du Centre website (larep.fr).';
