    ...
    const PARAMETERS = [
        [
            ...
            'url_selector' => [
                ...
                'title' => 'This bridge works using CSS selectors, '
            ...
            'content_selector' => [
                ...
                'title' => 'When specified, the bridge will fetch each article from its URL '
            ...
            'title_cleanup' => [
                ...
                'title' => 'When fetching each article page, feed item title comes from page title. '
