...
class LePopulaireDuCentreBridge extends BridgeAbstract
{
    const NAME = 'Le Populaire Du Centre';
    const URI = 'https://www.lepopulaire.fr/';
    const DESCRIPTION = 'Return latest headlines or local news for Le Populaire Du Centre website (lepopulaire.fr).';
