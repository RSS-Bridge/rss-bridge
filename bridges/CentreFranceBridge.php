...
class CentreFranceBridge extends BridgeAbstract
{
    ...
    public function collectData()
    {
        ...
        $html = getSimpleHTMLDOM('https://www.' . $this->getInput('newspaper') . '/' . $this->getInput('locality-slug') . '/');
        ...
        foreach ($html->find('.c-titre') as $articleTitleDOMElement) {
            ...
            if ($this->getInput('locality-slug') !== '' && !str_contains($articleURI, $this->getInput('locality-slug'))) {
                continue;
            }
