...
class LEveilDeLaHauteLoireBridge extends BridgeAbstract
{
    const NAME = 'L\'Éveil De la Haute-Loire';
    const URI = 'https://www.leveil.fr/';
    const DESCRIPTION = 'Return latest headlines or local news for L\'Éveil De la Haute-Loire website (leveil.fr).';
    ...
    const PARAMETERS = [
        ...
        'Local news' => [
            'locality-slug' => [
                ...
                'exampleValue' => 'puy-en-velay-43000'
            ],
        ]
    ];
