...
class MakroBridge extends BridgeAbstract
{
    const NAME = 'Makro Cash & Carry';
    const URI = 'https://www.makro.cz';
    const DESCRIPTION = 'Obchod se 45 druhů čerstvých ryb a mořských plodů, více než 450 druhů zeleniny a 400 druhů ovoce suchých plodů.';
