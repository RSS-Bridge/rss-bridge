...
class LEchoRepublicainBridge extends BridgeAbstract
{
    const NAME = 'L\'Écho Républicain';
    const URI = 'https://www.lechorepublicain.fr/';
    const DESCRIPTION = 'Return latest headlines or local news for L\'Écho Républicain website (lechorepublicain.fr).';
