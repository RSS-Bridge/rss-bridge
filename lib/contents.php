...
function getContents(
    ...
    return Container::instance()->get(Fetcher::class)->getContents($url, $httpHeaders, $curlOptions, $returnFull);
}
...
function getSimpleHTMLDOM(
    ...
    return Container::instance()->get(Fetcher::class)->getSimpleHTMLDOM(
        $url,
        $header,
        $opts,
        $lowercase,
...
function getSimpleHTMLDOMCached(
    ...
    return Container::instance()->get(Fetcher::class)->getSimpleHTMLDOMCached(
        $url,
        $duration,
        $header,
        $opts,
